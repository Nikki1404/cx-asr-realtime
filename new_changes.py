...
# ==========================================================
#           WHISPER NORMALIZER (GLOBAL STANDARD)
# ==========================================================
...
def normalize_text(text: str) -> str:
    """
    Apply Whisper normalization to both reference and hypothesis.
    """
    return normalizer(text)


# After whisper normalization, we just tokenize
